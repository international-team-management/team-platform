      ...
      <div className={styles['header__project-menu']}>
        <div className={styles['header__project-buttons']}>
          <div className={styles['header__button-area']}>
            <img className={styles['header__switch-icon']} src={kanbanIcon} alt="Кнопка Канбан"/>
            <button className={`${styles['header__switch-button']} ${styles['header__switch-button_active']}`}>
              Канбан
            </button>
          </div>
          <div className={styles['header__button-area']}>
            <img className={styles['header__switch-icon']} src={listIcon} alt="Кнопка Список"/>
