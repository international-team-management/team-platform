...
export const InputParticipantsSelect = (): JSX.Element => {
  ...
  const options = [
    { value: 'me', label: 'Montenegro', image: 'https://s1.1zoom.ru/b5050/243/Big_cats_Leopards_Snout_479812_1920x1200.jpg', inTeam:true },
    { value:'rs', label: 'Serbia', image: 'https://i.pinimg.com/originals/8a/a7/83/8aa7831e22f8d5c74aecfe0c0e6953e3.jpg', inTeam:true },
    { value: 'me', label: 'Montenegro', image: 'https://s1.1zoom.ru/b5050/243/Big_cats_Leopards_Snout_479812_1920x1200.jpg', inTeam:false },
    { value: 'me', label: 'Montenegro', image: 'https://s1.1zoom.ru/b5050/243/Big_cats_Leopards_Snout_479812_1920x1200.jpg', inTeam:true },
    { value:'rs', label: 'Serbia', image: 'https://i.pinimg.com/originals/8a/a7/83/8aa7831e22f8d5c74aecfe0c0e6953e3.jpg', inTeam:false },
    { value: 'me', label: 'Montenegro', image: 'https://s1.1zoom.ru/b5050/243/Big_cats_Leopards_Snout_479812_1920x1200.jpg', inTeam:true },
    { value: 'me', label: 'Montenegro', image: 'https://s1.1zoom.ru/b5050/243/Big_cats_Leopards_Snout_479812_1920x1200.jpg', inTeam:true },
    { value:'rs', label: 'Serbia', image: 'https://i.pinimg.com/originals/8a/a7/83/8aa7831e22f8d5c74aecfe0c0e6953e3.jpg', inTeam:false },
    { value: 'me', label: 'Montenegro', image: 'https://s1.1zoom.ru/b5050/243/Big_cats_Leopards_Snout_479812_1920x1200.jpg', inTeam:true }
  ...
  return (
    <div className={styles.participants}>
      <div className={styles.participants__container}>
        {avatars.map((option) => (<img className={styles.participants__avatar} src={option.image} alt={option.label} />))}
        <button type='button' className={styles.participants__avatar} onClick={handleAddNewMember}>{buttonNumber(options)}</button>
        <div className={`${styles.participants__select} ${
