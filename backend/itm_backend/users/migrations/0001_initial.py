    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_name', models.CharField(blank=True, help_text='Иванов', max_length=30, verbose_name='Фамилия')),
                ('role', models.CharField(blank=True, help_text='Ваша должность', max_length=50, verbose_name='Должность')),
                ...
                ('photo', django_resized.forms.ResizedImageField(blank=True, crop=None, force_format='JPEG', keep_meta=True, null=True, quality=75, scale=1, size=[400, 400], upload_to='media/', validators=[users.models.User.validate_photo], verbose_name='Аватар пользователя')),
