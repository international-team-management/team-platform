...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('priority', models.CharField(choices=[('maximum', 'Максимальный'), ('average', 'Средний'), ('minimum', 'Минимальный'), ('urgent', 'Срочно')], default='minimum', max_length=20, verbose_name='Приоритет задачи')),
